...
export default function Card({ data }: { data: PortfolioData }) {
  ...
  return (
    <div className="rounded-2xl overflow-hidden max-w-md border border-slate-200 p-4 transition duration-300 hover:shadow-xl hover:-translate-y-6 xsm:p-1 xsm:hover:-translate-y-0">
      <Link href={homepage} target="_blank">
        <Image
          className="rounded-t-2xl border border-slate-200 w-450 h-300 object-cover xsm:hidden"
